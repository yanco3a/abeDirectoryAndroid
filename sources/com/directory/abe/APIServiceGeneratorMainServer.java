...
public class APIServiceGeneratorMainServer {
    private static Builder builder = new Builder().baseUrl(Host.API_BASE_URL).addConverterFactory(GsonConverterFactory.create());
